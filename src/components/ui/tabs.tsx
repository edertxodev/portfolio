...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Root
    ...
    ref={ref}
    className={cn('flex p-1 border-3 border-white text-muted-foreground gap-1', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'flex flex-col h-auto items-center justify-start bg-green-800 dark:bg-muted p-1 text-neutral-200 dark:text-muted-foreground',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex items-center justify-start whitespace-nowrap px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm',
      className
    )}
    {...props}
  />
